 ...
 * @return {Object} - this
 */
function _libraryColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_libraryColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_libraryColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_libraryColor.prototype.getAccentColor = function() {
	var fallback;
 ...
 * @return {Object} - this
 */
function libraryColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _libraryColor( backgroundColor, accentHue );
